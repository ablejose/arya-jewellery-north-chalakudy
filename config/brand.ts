...
export const BRAND: BrandConfig = {
  ...
  description:
    "Arya Jewellery is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy and the surrounding areas with timeless craftsmanship and contemporary designs for every celebration.",
  ...
  mapsLink:
    "https://www.google.com/maps/search/?api=1&query=Arya%20Jewellery&query_place_id=ChIJ-3Zw-G8DCDsRUCuaugfUxQk",
  ...
  seo: {
    title: "Arya Jewellery | Jewellery in Chalakudy",
    description:
      "Arya Jewellery — your premier jewellery store in Chalakudy. Gold, diamond and silver jewellery crafted for every occasion. Visit us in Chalakudy, Kerala.",
    keywords: [
      "Arya Jewellery",
      "jewellery Chalakudy",
    ...
    canonical: "https://arya-jewellery-north-chalakudy.vercel.app",
    ogImage:
      "https://res.cloudinary.com/fylz5e3j/image/upload/v1782940196/hayazbb_wb1juf.webp",
  },
